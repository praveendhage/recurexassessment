<div class="admins index">
	...
	<tr>
		...
		<td><?php echo h($admin['Admin']['firstname']); ?>&nbsp;</td>
		<td><?php echo h($admin['Admin']['lastname']); ?>&nbsp;</td>
		<td><?php echo h($admin['Admin']['email']); ?>&nbsp;</td>
		<td><?php echo h($admin['Admin']['password']); ?>&nbsp;</td>
		<td><?php echo h($admin['Admin']['mobile']); ?>&nbsp;</td>
		<td><?php echo h($admin['Admin']['profile_pic']); ?>&nbsp;</td>
